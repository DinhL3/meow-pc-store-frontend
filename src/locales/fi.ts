export default {
  ...
  hero: {
    title: 'Tyylikkäät, tehokkaat tietokoneet',
    subtitle: 'Laadukkaat osat, kestävä rakenne, ammattitaidolla kasattu sinulle.',
    subtitleLine2: 'Säästä aikaa ja vaivaa - nauti luotettavasta suorituskyvystä ja mielenrauhasta.',
