          ...
          <Box>
            ...
            <List dense>
              <ListItem disableGutters>
                ...
                <ListItemText primary={t('customBuild.benefit1')} />
              </ListItem>
              <ListItem disableGutters>
                <ListItemIcon sx={{ minWidth: 36 }}>
                  <CheckCircleIcon sx={{ color: 'oceanBlue.main' }} />
                </ListItemIcon>
                <ListItemText primary={t('customBuild.benefit2')} />
              </ListItem>
              <ListItem disableGutters>
                <ListItemIcon sx={{ minWidth: 36 }}>
                  <CheckCircleIcon sx={{ color: 'oceanBlue.main' }} />
                </ListItemIcon>
                <ListItemText primary={t('customBuild.benefit3')} />
              </ListItem>
              <ListItem disableGutters>
                <ListItemIcon sx={{ minWidth: 36 }}>
                  <CheckCircleIcon sx={{ color: 'oceanBlue.main' }} />
                </ListItemIcon>
                <ListItemText primary={t('customBuild.benefit4')} />
              </ListItem>
            </List>
          </Box>
